      ...
      <div className="flex-1 border-l-2 border-gray-300">
        ...
        <div className="p-6 max-w-4xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* 개인 퀘스트 */}
            <Card className="border-2 border-gray-300 hover:border-blue-500 transition-colors cursor-pointer">
              <CardHeader>
            ...
            {/* 단체 퀘스트 */}
            <Card className="border-2 border-gray-300 hover:border-green-500 transition-colors cursor-pointer">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-black">
          ...
          <Card className="mt-6 bg-blue-50 border-blue-200">
            <CardContent className="p-4">
              <h3 className="font-semibold text-blue-900 mb-2">퀘스트 유형 안내</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-blue-800">
                <div>
                  <h4 className="font-medium mb-1">개인 퀘스트</h4>
                  <p>특정 학생의 학습 상황에 맞춘 맞춤형 퀘스트</p>
                </div>
                <div>
                  <h4 className="font-medium mb-1">단체 퀘스트</h4>
